...
<html lang="ja">
<head>
  <meta name="google-site-verification" content="oDaNbbpmf2UDCH7dAoBfZ7a7aTeTsf192hUSlZ0MAdY" />
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover">
  <meta name="theme-color" content="#e8944a">
  ...
  <meta name="twitter:title" content="@yield('title', config('app.name') . ' | 空きが出たらLINEで通知が届く保育園・幼稚園マップ')">
  <meta name="twitter:description" content="@yield('description', '全国の認可保育園・幼稚園を地図から探せる投稿型マップです。現在地から近い園をすぐ見つけられ、空き状況の口コミや写真付き口コミをリアルタイムで確認できます。空きが出たらLINEで通知が届きます。')">

  <link rel="icon" href="/favicon.ico" sizes="any">

  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css">
  <style>
    body { background-color: #fdf8f3; font-family: system-ui, -apple-system, sans-serif; }
    .btn { min-height: 44px; }
    .btn-line { background: #06c755; color: #fff; border: none; }
    .btn-line:hover { background: #05a848; color: #fff; }
    .btn-hoiku { background: #e8944a; color: #fff; border: none; }
    .btn-hoiku:hover { background: #cf7c33; color: #fff; }
    .badge-vacancy-yes { background: #2e9e5b; }
    .badge-vacancy-no { background: #9e9e9e; }
    .badge-vacancy-check { background: #d1a13a; }
  </style>
  @yield('styles')
...
<body>
  <nav class="navbar navbar-dark p-2" style="background-color:#c9762c;">
  ...
  {{-- 掲載施設は OpenStreetMap から取り込んでいる。ODbL 1.0 は出典表示を求めている。 --}}
  <footer class="border-top mt-5 py-4">
    <div class="container small text-muted">
      ...
      <p class="mb-0">最新の受け入れ状況・空き状況は各施設・自治体の公式情報をご確認ください。</p>
    </div>
  </footer>
