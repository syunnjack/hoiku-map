    ...
    public function callback(Request $request)
    {
        ...
        if ($intendedVenueId) {
            ...
            if ($venue) {
                ...
                return redirect()->route('venues.show', $venue)->with('success', '通知登録が完了しました。空きありの報告が投稿されるとLINEでお知らせします。');
            }
        }
        ...
        if ($intendedDocumentVenueId) {
            ...
            if ($venue) {
                ...
                return redirect()->route('venues.show', $venue)->with('success', '「' . $venue->name . '」への見学・入園相談を受け付けました。LINEで受付完了のお知らせをお送りします。');
            }
        }
